...
public final class Main {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Map<Integer, Map<Integer, Integer>> ruiseki = new HashMap<>();
    ...
    for (int i = 0; i < q; i++) {
      ...
      int x = fs.nextInt();
      if (l == 1) {
        System.out.println(ruiseki.get(r).getOrDefault(x, 0));
      } else {
        System.out
            .println(ruiseki.get(r).getOrDefault(x, 0) - ruiseki.get(l - 1).getOrDefault(x, 0));
      }
    }
  }
