...
public final class Main {
  ...
  public static void main(String[] args) throws IOException {
    ...
    int takahashi_cycle = x / (a + c);
    int takahashi_mod = x % (a + c);
    int aoki_cycle = x / (d + f);
    int aoki_mod = x % (d + f);

    int takahashi = (takahashi_cycle * (a * b)) + (b * Math.min(takahashi_mod, a));
    int aoki = (aoki_cycle * (d * e)) + (e * Math.min(aoki_mod, d));

    if (takahashi == aoki) {
      System.out.println("Draw");
    } else {
      System.out.println(takahashi > aoki ? "Takahashi" : "Aoki");
    }
