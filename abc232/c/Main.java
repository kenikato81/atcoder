...
public final class Main {
  ...
  public static void main(String[] args) throws IOException {
    ...
    for (int i = 0; i < m; i++) {
      ...
      a_map.put(b, a_map.getOrDefault(b, 0) + 1);
    }

    for (int i = 0; i < m; i++) {
      int c = fs.nextInt();
      int d = fs.nextInt();
      c_map.put(c, c_map.getOrDefault(c, 0) + 1);
      c_map.put(d, c_map.getOrDefault(d, 0) + 1);
    }
    ...
    for (Map.Entry<Integer, Integer> entry : c_map.entrySet()) {
